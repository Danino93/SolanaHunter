...
**מה אתה עושה:**
- [ ] הוסף Supabase Realtime
- [ ] כל טוקן חדש → מופיע בדשבורד בלי refresh
...
**מה אתה עושה:**
- [ ] הוסף TailwindCSS
- [ ] הוסף mini chart לכל טוקן (price action)
- [ ] הוסף פילטרים (score > 80, today only, etc.)
...
**מה אתה עושה:**
- [ ] ייצא private key מPhantom (ארנק ייעודי לבוט!)
- [ ] צור wallet client ב-Python
- [ ] בדוק balance
